...
CREATE TABLE `addresses` (
  ...
  `countryCode` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `administrativeArea` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `locality` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `dependentLocality` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `postalCode` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `sortingCode` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `addressLine1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `addressLine2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `organization` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `organizationTaxId` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `assetindexingsessions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `indexedVolumes` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
...
CREATE TABLE `assets` (
  ...
  `alt` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
...
CREATE TABLE `elementactivity` (
  ...
  KEY `idx_dkptxroktvmcfbixaznepwjzyrsubhlbjrts` (`elementId`,`timestamp`,`userId`),
  KEY `fk_zysgvewwozcnduzcykoticmgjubisihzqwvt` (`userId`),
  KEY `fk_aaeqloskglbvaudnmcacbuskcoufcldeotwl` (`siteId`),
  KEY `fk_ekpdrixwcwtrgbiovgrpaoufxrmwxwbutyyq` (`draftId`),
  CONSTRAINT `fk_aaeqloskglbvaudnmcacbuskcoufcldeotwl` FOREIGN KEY (`siteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_ekpdrixwcwtrgbiovgrpaoufxrmwxwbutyyq` FOREIGN KEY (`draftId`) REFERENCES `drafts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_woqnnftqidnwwwfqwjvsdsxvvsujwqjdbdag` FOREIGN KEY (`elementId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_zysgvewwozcnduzcykoticmgjubisihzqwvt` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `entrytypes` VALUES (1,1,1,'Home','home',0,'site',NULL,'{section.name|raw}','site',NULL,1,1,'2023-04-12 22:31:55','2023-04-12 22:31:55',NULL,'b735d688-a8ce-450c-92f3-0c09006ba218');
...
CREATE TABLE `imagetransformindex` (
  ...
  `transformer` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `imagetransforms` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `handle` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `mode` enum('stretch','fit','crop','letterbox') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'crop',
  ...
  `fill` varchar(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
INSERT INTO `info` VALUES (1,'4.5.6.1','4.5.3.0',0,'ozcbmnbornun','3@hxhlxsfxgk','2023-04-12 22:23:31','2024-01-17 14:31:28','885517e8-0caf-4319-9caf-197202d739cb');
...
CREATE TABLE `lenz_linkfield` (
  ...
  `fieldId` int NOT NULL,
  `siteId` int NOT NULL,
  `type` varchar(63) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `linkedUrl` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `linkedId` int DEFAULT NULL,
  `linkedSiteId` int DEFAULT NULL,
  `linkedTitle` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `neoblocktypes` (
  ...
  `childBlocks` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
...
INSERT INTO `plugins` VALUES (1,'redactor','3.0.4','2.3.0','2023-04-12 22:33:17','2023-04-12 22:33:17','2023-04-12 22:33:17','96d2f798-62e7-4fb0-aa8a-fcfc00c724f0'),(2,'seomatic','4.0.32','3.0.12','2023-04-12 22:33:42','2023-04-12 22:33:42','2024-01-16 18:51:47','e93e7569-9f2e-446c-b213-da826c53e520'),(3,'neo','3.9.5','3.6.2','2023-04-12 22:38:17','2023-04-12 22:38:17','2024-01-16 18:51:39','b440c86a-53b9-4dea-93de-b42eec8a7810'),(4,'typedlinkfield','2.1.5','2.0.0','2023-04-12 22:38:40','2023-04-12 22:38:40','2023-04-12 22:38:40','6024f6d0-8702-44c0-86b7-267fb2f97f85'),(5,'super-table','3.0.12','3.0.0','2023-04-12 22:38:43','2023-04-12 22:38:43','2024-01-16 18:51:39','cdef07e8-3286-46f1-b68c-b21ed7101699'),(6,'vite','4.0.6','1.0.0','2023-04-12 22:38:46','2023-04-12 22:38:46','2024-01-16 18:51:39','ee8c926a-7d22-40fa-a835-8f23849cc8e9'),(7,'retour','4.1.14','3.0.12','2024-01-17 14:29:45','2024-01-17 14:29:45','2024-01-17 14:29:45','dfe01881-55bb-41f6-83cf-b66ab648a158');
...
INSERT INTO `resourcepaths` VALUES ('17e7746e','@craft/web/assets/vue/dist'),('31b3c95c','@craft/web/assets/xregexp/dist'),('33d71e98','@craft/web/assets/craftsupport/dist'),('3a0b745c','@craft/web/assets/picturefill/dist'),('3c7ac35','@craft/web/assets/velocity/dist'),('446243f7','@craft/web/assets/fileupload/dist'),('50fe054a','@bower/jquery/dist'),('551e1aa2','@craft/web/assets/elementresizedetector/dist'),('5a19955c','@craft/web/assets/jqueryui/dist'),('60371e0','@craft/web/assets/jquerytouchevents/dist'),('650ae82','@craft/web/assets/jquerypayment/dist'),('6b709f83','@nystudio107/seomatic/web/assets/dist'),('75810517','@craft/web/assets/dashboard/dist'),('824d9348','@craft/web/assets/selectize/dist'),('8558296a','@craft/web/assets/tailwindreset/dist'),('877e017d','@craft/web/assets/pluginstore/dist'),('8e053100','@craft/web/assets/cp/dist'),('94301749','@craft/web/assets/d3/dist'),('9f511efe','@craft/web/assets/iframeresizer/dist'),('aac1aaff','@craft/web/assets/recententries/dist'),('b2343fa6','@craft/web/assets/axios/dist'),('c4dd9ff4','@craft/web/assets/fabric/dist'),('cc223dc','@craft/web/assets/feed/dist'),('d45058b','@nystudio107/retour/web/assets/dist'),('ec6fa8e3','@craft/web/assets/garnish/dist');
...
CREATE TABLE `retour_redirects` (
  ...
  `redirectSrcUrl` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT '',
  `redirectSrcUrlParsed` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT '',
  `redirectSrcMatch` varchar(32) COLLATE utf8mb3_unicode_ci DEFAULT 'pathonly',
  `redirectMatchType` varchar(32) COLLATE utf8mb3_unicode_ci DEFAULT 'exactmatch',
  `redirectDestUrl` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT '',
  `redirectHttpCode` int DEFAULT '301',
  `priority` int DEFAULT '5',
  `hitCount` int DEFAULT '1',
  `hitLastTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_dbergxvrwfblovblxbsezlocmeblziojgmso` (`redirectSrcUrlParsed`),
  KEY `idx_zyzgugnekvzriigsiotihaluccwpiqeuzygm` (`redirectSrcUrl`),
  KEY `idx_yckoxsomxhphmrdvxqvbeqffeigiycamaefz` (`redirectMatchType`),
  KEY `idx_lcdhqhshcrtcqxtrkbeiqnolpjwupxhhesqy` (`siteId`),
  KEY `fk_moxukqnvzqexfeydaqekncjbgvmxhohzepxz` (`associatedElementId`),
  CONSTRAINT `fk_moxukqnvzqexfeydaqekncjbgvmxhohzepxz` FOREIGN KEY (`associatedElementId`) REFERENCES `elements` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `retour_static_redirects` (
  ...
  `hitLastTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_crpwqpkpknxefarhcmvlgkihdbpwchfdduey` (`redirectSrcUrlParsed`),
  KEY `idx_kxiemlwhjroxzlrwwqfbgflokzxpnjpcgfdp` (`redirectSrcUrl`),
  KEY `idx_vduxjkqmutanttluqwlwunopjkxmdwatbdou` (`redirectMatchType`),
  KEY `idx_wzqftuwgmelkrzrkbrjouomahcyphvoyrxyw` (`siteId`),
  CONSTRAINT `fk_eidvfmsmyjtmkuxndsfxqpgbnodadsojiasm` FOREIGN KEY (`siteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `retour_stats` (
  ...
  `siteId` int DEFAULT NULL,
  `redirectSrcUrl` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT '',
  `referrerUrl` varchar(2000) COLLATE utf8mb3_unicode_ci DEFAULT '',
  `remoteIp` varchar(45) COLLATE utf8mb3_unicode_ci DEFAULT '',
  `userAgent` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT '',
  `exceptionMessage` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT '',
  `exceptionFilePath` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT '',
  `exceptionFileLine` int DEFAULT '0',
  `hitCount` int DEFAULT '1',
  `hitLastTime` datetime DEFAULT NULL,
  `handledByRetour` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_qzlayjochsyfggipqkncbuvofuylmyeastid` (`redirectSrcUrl`),
  KEY `idx_mzlsvchwjjgroehtdxcsdgioujhitvrodbsd` (`siteId`),
  CONSTRAINT `fk_yimrpqvgpnnnqbatzthnevbrazzjrrqsweco` FOREIGN KEY (`siteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `seomatic_metabundles` (
  ...
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '0',
  `bundleVersion` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `sourceBundleType` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `sourceId` int DEFAULT NULL,
  `sourceName` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `sourceHandle` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `sourceType` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `typeId` int DEFAULT NULL,
  `sourceTemplate` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT '',
  `sourceSiteId` int DEFAULT NULL,
  `sourceAltSiteSettings` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `sourceDateUpdated` datetime NOT NULL,
  `metaGlobalVars` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `metaSiteVars` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `metaSitemapVars` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `metaContainers` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `redirectsContainer` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `frontendTemplatesContainer` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `metaBundleSettings` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  PRIMARY KEY (`id`),
...
INSERT INTO `sessions` VALUES (4,1,'XeO4lkKnTGPAF23T6IjGw0pVWCA6Nkao81V-ORXxtzW0wXCtU0CmAinWw7dieqPBNI9bYAxb9BNhsGVvUjjKe0VlY3FRdhkmR2Uv','2024-01-17 14:29:29','2024-01-17 14:34:55','b6654994-7aeb-497b-8eab-702e65b3bdb3');
...
CREATE TABLE `sites` (
  ...
  `enabled` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'true',
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `handle` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
INSERT INTO `users` VALUES (1,NULL,1,0,0,0,1,'steadfast',NULL,NULL,NULL,'dev@steadfast.design','$2y$13$i1fEVeKiboWR/Hx07N9JtuSZj46KNueAg0IgpwL2TId0sXN.oyibC','2024-01-17 14:29:29',NULL,NULL,NULL,'2023-04-13 13:28:31',NULL,1,NULL,NULL,NULL,0,'2023-04-12 22:23:31','2023-04-12 22:23:31','2024-01-17 14:29:29');
...
CREATE TABLE `volumes` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `handle` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `fs` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `transformFs` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `transformSubpath` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `titleTranslationMethod` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'site',
  `titleTranslationKeyFormat` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `sortOrder` smallint unsigned DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
...
-- Dump completed on 2024-01-17 14:35:13
